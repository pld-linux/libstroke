...
%description -l pl
LibStroke to biblioteka tЁumacz╠ca ruchy myszk╠. Ruchy mog╠ byФ
przechwycone przez program i zinterpretowane jako komenda. Tego typu
komendy s╠ bardzo czЙsto stosowane w programach typu CAD.
...
Pliki nagЁСwkowe i dokumetacja do libstroke.
